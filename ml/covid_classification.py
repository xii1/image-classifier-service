...
SAVED_WEIGHTS = 'trained_models/classification/vgg16_covid_model_weights.h5'
...
NAME = {0: 'Covid', 1: 'Normal', 2: 'Viral Pneumonia'}
...
def train_model_by_transfer_learning_with_vgg16():
    ...
    training_set = train_datagen.flow_from_directory('data/covid19/train',
                                                     target_size=(IMAGE_WIDTH, IMAGE_HEIGHT),
                                                     batch_size=BATCH_SIZE, class_mode='categorical')
    test_set = test_datagen.flow_from_directory('data/covid19/test', target_size=(IMAGE_WIDTH, IMAGE_HEIGHT),
                                                batch_size=BATCH_SIZE, class_mode='categorical')
