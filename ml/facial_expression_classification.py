...
SAVED_WEIGHTS = 'trained_models/classification/vgg16_facial_expression_model_weights.h5'
...
NAME = {0: 'Anger', 1: 'Contempt', 2: 'Disgust', 3: 'Fear', 4: 'Happy', 5: 'Sadness', 6: 'Surprise'}
...
def create_model_with_vgg16():
    ...
    fc_layer = Dense(512, activation=activations.relu)(vgg.output)
    fc_layer = BatchNormalization()(fc_layer)
    fc_layer = Dropout(0.4)(fc_layer)
    fc_layer = Dense(128, activation=activations.relu)(fc_layer)
    fc_layer = BatchNormalization()(fc_layer)
    fc_layer = Dropout(0.4)(fc_layer)
...
def train_model_by_transfer_learning_with_vgg16():
    ...
    training_set = train_datagen.flow_from_directory('data/facial_expression',
                                                     target_size=(IMAGE_WIDTH, IMAGE_HEIGHT),
                                                     batch_size=BATCH_SIZE, class_mode='categorical', subset='training')
    test_set = train_datagen.flow_from_directory('data/facial_expression', target_size=(IMAGE_WIDTH, IMAGE_HEIGHT),
